/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 7388852d0443f9cb289b477ecbc20a59)
// Runtime types generated with workerd@1.20260730.1 2026-08-01 enable_request_signal
interface __BaseEnv_Env {
	...
	SESSION_HMAC_KEYS: string;
	SESSION_ENCRYPTION_KEYS: string;
	MATCH_DO: DurableObjectNamespace<import("./src/index").MatchDO>;
	SESSION_COORDINATOR_DO: DurableObjectNamespace<import("./src/index").SessionCoordinatorDO>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "MatchDO" | "SessionCoordinatorDO";
	}
